-- A7DEV Project Slayer 2 | Runtime V20 Reference Style
...
local C={
    red=Color3.fromRGB(116,175,245), red2=Color3.fromRGB(39,62,89),
...
if State.Runtime and State.Runtime.Theme then
    ...
    State.Runtime.Theme.Red = Color3.fromRGB(116,175,245)
    State.Runtime.Theme.RedDark = Color3.fromRGB(39,44,51)
