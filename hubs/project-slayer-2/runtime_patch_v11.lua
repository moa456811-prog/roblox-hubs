-- A7DEV Project Slayer 2 | Runtime V11
...
local function installCrowQuest(State,gui)
    if State.CrowQuestOps and State.CrowQuestOps.A7DEV_V11 then return end
    ...
    local Ops={A7DEV_V11=true,NextTry=0,PendingUntil=0}
